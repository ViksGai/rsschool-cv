...
const selfSetimation = {
    'вёрстка валидная': 10,
    'вёрстка семантическая': 16,
    'css-стили': 10, 
    'контент размещается в блоке' :10,
    'вёрстка адаптивная' :10,
    'есть адаптивное бургер-меню' :10,
    'присутствует изображение' :10,
    'контакты и навыки оформлены в виде списка ul > li' :10,
    ...
    'дизайн, оформление, качество выполнения CV' :10
}

console.log(selfSetimation);
